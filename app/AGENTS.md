...
- Harp strings must stay visible while paused (dimmer), because plucking is allowed while paused; while playing they read as comet trails, not full orbit grids. Every trail/rim/ribbon color derives from `voiceVisual` plus `dopplerTintedColor` (approach cools toward cyan, recession warms toward coral). No separate trail palette.
