...
const SOLAR_SYSTEM_LANDMARK = Object.freeze({
      ...
      system: Object.freeze({
        ...
        bodies: Object.freeze([
          Object.freeze({ id: "mercury", name: "MERCURY", kind: "planet", periodDays: 87.969, orbitAu: 0.38709927, radiusEarth: 0.3826, massEarth: 0.0553, massSource: "measured", eccentricity: 0.20563593, color: 0xdcc7ae }),
          Object.freeze({ id: "venus", name: "VENUS", kind: "planet", periodDays: 224.701, orbitAu: 0.72333566, radiusEarth: 0.9488, massEarth: 0.815, massSource: "measured", eccentricity: 0.00677672, color: 0xdcd9d2 }),
          Object.freeze({ id: "earth", name: "EARTH", kind: "planet", periodDays: 365.256, orbitAu: 1, radiusEarth: 1, massEarth: 1, massSource: "measured", eccentricity: 0.01671123, color: 0xc6ccdc }),
          Object.freeze({ id: "mars", name: "MARS", kind: "planet", periodDays: 686.98, orbitAu: 1.52371034, radiusEarth: 0.5325, massEarth: 0.107, massSource: "measured", eccentricity: 0.0933941, color: 0xdcae80 }),
          Object.freeze({ id: "jupiter", name: "JUPITER", kind: "planet", periodDays: 4332.82, orbitAu: 5.202887, radiusEarth: 11.2089, massEarth: 317.8, massSource: "measured", eccentricity: 0.04838624, color: 0xdadccb }),
          Object.freeze({ id: "saturn", name: "SATURN", kind: "planet", periodDays: 10_755.699, orbitAu: 9.53667594, radiusEarth: 9.4492, massEarth: 95.16, massSource: "measured", eccentricity: 0.05386179, color: 0xdcccac, rings: true }),
          Object.freeze({ id: "uranus", name: "URANUS", kind: "planet", periodDays: 30_687.153, orbitAu: 19.18916464, radiusEarth: 4.0073, massEarth: 14.54, massSource: "measured", eccentricity: 0.04725744, color: 0x9acfdc }),
          ...
          Object.freeze({ id: "neptune", name: "NEPTUNE", kind: "planet", periodDays: 60_190.03, orbitAu: 30.06992276, radiusEarth: 3.8826, massEarth: 17.15, massSource: "measured", eccentricity: 0.00859048, color: 0x90c6dc }),
        ]),
      }),
    });
